...
licenseClient.initialize(config);
...
describe('Cliente de licencias', function() {
  ...
  describe('Verificación de licencia', function() {
    ...
    it.skip('debería verificar una licencia offline cuando el servidor no está disponible', async function() {
    ...
    it('debería rechazar una licencia expirada en modo offline', async function() {
      ...
      const originalOfflineMode = config.offlineMode;
      config.offlineMode = true;

      const result = await licenseClient.verifyLicense(licenseKey);

      // Restaurar configuración
      config.offlineMode = originalOfflineMode;
